...
public interface RoomsRepository extends JpaRepository<Rooms, Integer> {
	...
	@Query(value = "select * from rooms where hotel_id = :hotelId and is_available = true", nativeQuery = true)
	List<Rooms> getAvailableRooms(@Param("hotelId") Integer hotelId);

	@Query(value = "select * from rooms where hotel_id = :hotelId and is_ac = true", nativeQuery = true)
	...
	List<Rooms> getRoomsByBedType(@Param("bedType") String bedType); 
