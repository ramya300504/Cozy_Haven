...
class PaymentServiceImplTest {
	...
	void testProcessPayment() {
		 ...
		 PaymentDTO paymentDTO = new PaymentDTO(null,LocalDateTime.now(),2500.00,"CREDIT_CARD", "SUCCESS");
	...
	void testUpdatePayment() throws PaymentIdNotFoundException {
	    ...
	    PaymentDTO updatedDTO = new PaymentDTO(processedPayment.getPaymentId(),LocalDateTime.now(), 3000.00,"DEBIT_CARD","FAILED");
